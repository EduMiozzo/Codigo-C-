...
//
/*         Eduardo Miozzo
       Aula: Internet das Coisas
      Atividade realizada em 18/10/22
         OBS: Incluir no Github 
      
    controlar a velocidade do motor pelo potenciometro
    lido na entrada analogica A0 e o motor conectado na saida PWM 10
*/
